import { GluestackUIProvider, Text, Box, Image, Center, Heading, FormControl, FormControlLabel, FormControlLabelText, Input, InputField, HStack, Button, ButtonText } from "@gluestack-ui/themed"
      ...
      <Box bg="#E2F9B8" p="$7" h={"$full"} w={"$full"}  justifyContent="center" alignItems="center">
        ...
        <FormControl >
          ...
          <Box justifyContent="space-around" display="flex" flexDirection="row" >
            <Button onPress={calcularHandle} bg="#D16014">
              <ButtonText>Calcular</ButtonText>
            </Button>
            <Button onPress={limparHandle} bg="#D16014">
              <ButtonText>Limpar</ButtonText>
            </Button>
          </Box>
          <Box justifyContent="space-around" alignItems="center" height={100} flexDirection="row" display="flex">
            <Text color="#D16014">Resultado:</Text>
            <Text fontWeight="$bold">{resultado}</Text>
          </Box>
        </FormControl>
        <Image source={sexo ? mulher : homem} height={'40%'} w={'$80%'} alt="imagem do tipo do sexo"/>
      </Box>
    </GluestackUIProvider>
  )
}